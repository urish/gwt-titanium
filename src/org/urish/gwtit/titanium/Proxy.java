 ...
 * @since 0.1
 */
public class Proxy extends JavaScriptObject {
	protected Proxy() {
	}
	 ...
	 */
	public native void addEventListener(String name, Object callback)
	/*-{
	 ...
	 */
	public native void removeEventListener(String name, Object callbac)
	/*-{
