 ...
 * 
 */
public class ScrollableViewScrollEvent extends TouchEvent {

	public final static String NATIVE_EVENT_NAME = "scroll";

	protected ScrollableViewScrollEvent() {
	}
	 ...
	 */
	public final native org.urish.gwtit.titanium.ui.View getView()
	/*-{
		return this.view;
	}-*/;
