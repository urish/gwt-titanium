...
/**
 * The callback to be fired when a async read operation finishes
 * 
 * @since 1.7
 */
public class ReadCallbackArgs extends JavaScriptObject {
	protected ReadCallbackArgs() {
	}

	/**
	 * @return Stream being read
	 */
