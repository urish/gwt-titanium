...
public class Locale extends org.urish.gwtit.titanium.Module {
	...
	/*-{
		return Titanium.Locale.removeEventListener(name, function(e) { callback.@org.urish.gwtit.client.EventCallback::onEvent(Lcom/google/gwt/core/client/JavaScriptObject;)(e); });
	}-*/;
