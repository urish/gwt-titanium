...
public class Calendar extends org.urish.gwtit.titanium.Module {
	...
	/*-{
		return Titanium.Android.Calendar.addEventListener(name, function(e) { callback.@org.urish.gwtit.client.EventCallback::onEvent(Lcom/google/gwt/core/client/JavaScriptObject;)(e); });
	}-*/;
	...
	/*-{
		return Titanium.Android.Calendar.removeEventListener(name, function(e) { callback.@org.urish.gwtit.client.EventCallback::onEvent(Lcom/google/gwt/core/client/JavaScriptObject;)(e); });
	}-*/;
