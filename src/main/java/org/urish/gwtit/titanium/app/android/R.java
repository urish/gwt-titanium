...
package org.urish.gwtit.titanium.app.android;
 ...
 * have a file `platform/android/res/drawable/icon.png` in your project, you
 * could then access its integer id like this:
 * 
